...
import Receipt from 'views/user/main/Uploads/uploadDetails/components/Receipt';
import Details from 'views/user/main/Uploads/uploadDetails/components/Details';
